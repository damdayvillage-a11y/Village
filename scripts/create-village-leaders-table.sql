-- Village Leaders Table Creation Script
...
-- Insert default village leaders (only if they don't exist)
...
SELECT 'Village leaders table created successfully!' as status;
SELECT COUNT(*) as total_leaders FROM "village_leaders";
