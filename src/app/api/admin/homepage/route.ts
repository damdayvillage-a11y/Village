...
export async function GET(request: NextRequest) {
  try {
    ...
    try {
      ...
      // Return default config with database connection warning
      const defaultConfig = {
        id: null,
      ...
      return NextResponse.json({
        ...
        warning: 'Database not connected. Using default configuration. Changes will not be saved.',
      });
    }
