...
export default function AdminPanelPage() {
  ...
  const sidebarItems = [
    ...
    { id: 'pages', label: 'Page Manager', icon: FileText, section: 'content', href: '/admin-panel/cms/page-builder' },
    { id: 'homepage-editor', label: 'Homepage Editor', icon: Home, section: 'content', href: '/admin-panel/homepage-editor' },
