      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Join Smart Carbon-Free Village Community
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              >
                <option value="GUEST">Guest - Explore & Visit</option>
                <option value="HOST">Host - Offer Homestays</option>
                <option value="SELLER">Seller - Marketplace Vendor</option>
                <option value="RESEARCHER">Researcher - Academic/Research</option>
              </select>
            </div>
